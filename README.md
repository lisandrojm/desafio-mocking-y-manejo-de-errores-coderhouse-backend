...
- Generación de un módulo de Mocking para el servidor. Al inicializarse genera y entrega 100 productos con el mismo formato que de una petición de MongoDB. Ésto solo ocurre en el endpoint determinado (‘/mockingproducts’)
